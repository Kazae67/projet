 ...
 */
final class Version20231206191324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE archived_order_detail ADD CONSTRAINT FK_4271C0588DE820D9 FOREIGN KEY (seller_id) REFERENCES `user` (id)');
