...
-- Listage des données de la table projet.adress : ~21 rows (environ)
...
-- Listage des données de la table projet.archived_order : ~70 rows (environ)
...
-- Listage des données de la table projet.archived_order_detail : ~76 rows (environ)
...
-- Listage des données de la table projet.order : ~62 rows (environ)
...
-- Listage des données de la table projet.order_detail : ~54 rows (environ)
INSERT INTO `order_detail` (`id`, `order_id`, `quantity`, `price`, `subtotal`, `product_id`) VALUES
	...
	(315, 258, 1, 10.00, 10.00, 1),
	(316, 259, 1, 10.00, 10.00, 1),
	(317, 260, 1, 10.00, 10.00, 1),
	(318, 261, 1, 10.00, 10.00, 1),
	(319, 262, 1, 10.00, 10.00, 1),
	(320, 263, 1, 10.00, 10.00, 1),
	(321, 264, 2, 10.00, 20.00, 1),
	(322, 265, 2, 30.00, 60.00, 2),
	(323, 266, 1, 10.00, 10.00, 1),
	(324, 266, 1, 1.00, 1.00, 41);
...
-- Listage des données de la table projet.order_tracking : ~38 rows (environ)
...
-- Listage des données de la table projet.payment : ~39 rows (environ)
...
-- Listage des données de la table projet.product : ~26 rows (environ)
INSERT INTO `product` (`id`, `user_id`, `category_id`, `name`, `description`, `price`, `stock_quantity`, `is_active`, `image_url`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, 'name product', 'description product', 10.00, 380, 1, 'default.image.jpg', '2023-10-26 19:53:48', '2023-11-28 20:23:46'),
	(2, 1, 1, 'lol', 'maaaaa', 30.00, 6, 1, 'default.image.jpg', '2023-10-26 20:19:38', '2023-11-28 13:50:44'),
	(3, 1, 1, 'am', 'nana', 20.00, 3, 1, 'default.image.jpg', '2023-10-26 22:47:04', '2023-11-28 14:15:11'),
	...
	(7, 1, 1, 'tatatata', 'ze', 20.00, 2, 1, 'default.image.jpg', '2023-10-26 22:47:04', '2023-11-28 20:45:28'),
	...
	(38, 81, 1, 'https https h', 'https http ssz', 1.00, 0, 1, NULL, '2023-11-21 23:49:24', '2023-11-28 13:03:00'),
	(39, 81, 1, 'test 12', 'testeuuuuuhh', 1.50, 2, 1, NULL, '2023-11-22 00:13:10', '2023-11-22 00:14:26'),
	(41, 81, 1, 'teste', 'azeaeaze eaze', 1.00, 0, 1, NULL, '2023-11-22 09:35:26', '2023-11-28 20:23:46'),
	(55, 91, 1, 'aaahzaet', 'azezatzaztaerzae', 20.00, 1, 1, NULL, '2023-11-28 19:48:48', '2023-11-28 19:48:48'),
	(56, 91, 1, 'LOOOLOL', 'azezaeza eaze a', 2.00, 10, 1, NULL, '2023-11-28 19:57:55', '2023-11-28 19:57:55'),
	(57, 91, 1, 'dernier test lol', 'zoaekaozezaazeza', 10.00, 1, 1, NULL, '2023-11-28 20:01:13', '2023-11-28 20:01:13'),
	(58, 91, 1, 'ezaezaez aoezak zoak', 'aozekzaoekzaoekzaoe', 10.00, 2, 1, NULL, '2023-11-28 20:01:44', '2023-11-28 20:01:44'),
	(59, 91, 1, 'teeesraez', 'ezaeazt atrae', 10.00, 1, 1, NULL, '2023-11-28 20:02:13', '2023-11-28 20:02:13'),
	(60, 91, 1, 'test test test', 'teaze aze zaea e', 10.00, 10, 1, NULL, '2023-11-28 20:09:27', '2023-11-28 20:09:27'),
	(61, 91, 1, 'teazeae ae azea', 'ezae zaez aea aea', 10.00, 1, 1, NULL, '2023-11-28 20:16:51', '2023-11-28 20:16:51'),
	(62, 91, 1, 'test dajout', 'aozekae kazea zak', 10.00, 1, 1, NULL, '2023-11-29 09:04:06', '2023-11-29 09:04:06'),
	(63, 91, 1, 'test ajout slot', 'dzaoekzaoekao', 10.00, 1, 1, NULL, '2023-11-29 09:34:06', '2023-11-29 09:34:06');
...
-- Listage des données de la table projet.user : ~85 rows (environ)
...
-- Listage des données de la table projet.wishlist : ~4 rows (environ)
INSERT INTO `wishlist` (`id`, `user_id`, `product_id`, `added_at`) VALUES
	(10, 70, 1, '2023-11-14 13:13:01'),
	(17, 77, 1, '2023-11-16 12:34:16'),
	(22, 91, 38, '2023-11-28 13:03:00'),
	(23, 91, 3, '2023-11-28 14:15:11'),
	(24, 91, 7, '2023-11-28 20:45:28');
