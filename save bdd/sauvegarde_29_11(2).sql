...
-- Listage des données de la table projet.adress : ~23 rows (environ)
...
-- Listage des données de la table projet.archived_order : ~79 rows (environ)
...
-- Listage des données de la table projet.payment : ~40 rows (environ)
...
-- Listage des données de la table projet.product : ~10 rows (environ)
INSERT INTO `product` (`id`, `user_id`, `category_id`, `name`, `description`, `price`, `stock_quantity`, `is_active`, `image_url`, `created_at`, `updated_at`) VALUES
	(70, 91, 1, '1er produit', 'zaeazezaea', 12.00, 0, 1, NULL, '2023-11-29 10:53:50', '2023-11-29 13:22:39'),
	(71, 91, 1, '2 eme produit', 'azezaeza zaeae', 1.00, 1, 1, NULL, '2023-11-29 10:54:11', '2023-11-29 13:03:05'),
	(72, 91, 1, '3eme produit', 'oazkeoakezaoeka ea', 1.00, 1, 1, NULL, '2023-11-29 10:55:11', '2023-11-29 13:03:05'),
	(73, 91, 1, '4eme produit', 'aze1a2eza1eaaze', 1.00, 1, 1, NULL, '2023-11-29 10:58:10', '2023-11-29 13:03:05'),
	(74, 91, 1, '5eme produit', 'testze aeza zeazaeza', 1.00, 1, 1, NULL, '2023-11-29 10:59:45', '2023-11-29 13:03:05'),
	(75, 93, 1, 'produit 1', 'test de produuit', 2.00, 1, 1, NULL, '2023-11-29 11:14:03', '2023-11-29 13:12:02'),
	(76, 93, 1, 'produit 2', 'azezaeza ezae aaz', 1.00, 1, 1, NULL, '2023-11-29 11:14:33', '2023-11-29 13:12:02'),
	(77, 93, 1, 'produit 3', 'zaea ezae aeaze', 1.00, 1, 1, NULL, '2023-11-29 11:15:07', '2023-11-29 13:12:02'),
	(78, 93, 1, 'produit 4', 'aozekzaoekza eozakeaok eozaek aozekao', 1.00, 1, 1, NULL, '2023-11-29 11:15:51', '2023-11-29 13:12:02'),
	(79, 93, 1, 'ajout 5', 'test eza ezaeazeza e', 1.00, 1, 1, NULL, '2023-11-29 13:19:40', '2023-11-29 13:19:40');
...
-- Listage des données de la table projet.user : ~86 rows (environ)
INSERT INTO `user` (`id`, `username`, `password`, `email`, `role`, `last_login`, `profile_picture`, `created_at`, `updated_at`, `default_billing_address_id`, `default_delivery_address_id`) VALUES
	...
	(93, 'testslot', '$2y$04$HpMFJPnO5hrVEQd.oaqh0ey29mtGo6F56WOdaCX8c/PBanRyYhi0S', 'testslot@gmail.com', 'craftsman', '2023-11-29 11:13:32', NULL, '2023-11-29 11:13:19', '2023-11-29 13:21:51', 133, 134);
