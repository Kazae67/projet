...
INSERT INTO `adress` (`id`, `user_id`, `type`, `street`, `city`, `state`, `postal_code`, `country`, `is_default_billing`, `is_default_delivery`, `is_active`) VALUES
	...
	(131, 91, 'billing', 'Billing LOLOL', 'test', 'azeaze', '67100', 'FR', 0, 0, 1),
	(132, 91, 'delivery', 'Delivery tes3', 'Delivery city', 'Delivery province', '67100', 'FR', 0, 0, 1);
...
-- Listage des données de la table projet.archived_order : ~77 rows (environ)
...
-- Listage des données de la table projet.archived_order_detail : ~82 rows (environ)
...
-- Listage des données de la table projet.order : ~61 rows (environ)
...
-- Listage des données de la table projet.order_detail : ~48 rows (environ)
...
-- Listage des données de la table projet.payment : ~38 rows (environ)
...
INSERT INTO `product` (`id`, `user_id`, `category_id`, `name`, `description`, `price`, `stock_quantity`, `is_active`, `image_url`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, 'name product', 'description product', 10.00, 381, 1, 'default.image.jpg', '2023-10-26 19:53:48', '2023-11-28 13:40:16'),
	...
	(49, 91, 1, 'je test le produit', 'je lui donne une descript', 15.00, 10, 1, NULL, '2023-11-28 19:12:05', '2023-11-28 19:12:05');
